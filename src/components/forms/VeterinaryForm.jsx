...
export default function VeterinaryForm({ onSubmit }) {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div className="rounded-2xl border border-ink/10 bg-[linear-gradient(135deg,rgba(255,247,237,0.96),rgba(255,255,255,0.98))] p-4 ">
      ...
      <div className="flex justify-end border-t border-ink/10 pt-2">
        <button type="submit" className="btn-command inline-flex items-center justify-center rounded-lg bg-danger px-5 py-2.5 text-sm font-semibold text-surface  ">
