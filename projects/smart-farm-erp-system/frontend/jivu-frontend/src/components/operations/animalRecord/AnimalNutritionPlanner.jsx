...
export default function AnimalNutritionPlanner({ animal }) {
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="space-y-6 lg:border-r lg:border-ink/10 lg:pr-8">
          ...
          <div className="space-y-4">
            <div>
              <label className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-ink-muted">{LABELS.TARGET_MILK} (L/day)</label>
        ...
        <div className="flex min-h-[250px] flex-col">
          <h5 className="mb-4 text-[10px] font-bold uppercase tracking-wider text-ink-muted">Results</h5>
          <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-ink/20 bg-surface-warm/30 p-8 text-center">
            ...
            {plannerResult && !plannerResult.error && (
              <div className="w-full space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between border-b py-2"><span className="text-ink-muted">Extra Litres / day</span><strong className="font-mono">{plannerResult.extraLitresPerDay.toLocaleString(undefined, { maximumFractionDigits: 2 })} L</strong></div>
